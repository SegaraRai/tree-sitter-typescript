fn main() {
    ...
    if !"node_modules/tree-sitter-javascript/queries/injections.scm".is_empty() && std::path::Path::new("node_modules/tree-sitter-javascript/queries/injections.scm").exists() {
