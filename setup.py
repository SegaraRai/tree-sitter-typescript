...
class EggInfo(egg_info):
    def find_sources(self):
        ...
        self.filelist.recursive_include("typescript/src", "*.c")
        self.filelist.recursive_include("typescript/src/tree_sitter", "*.h")
        self.filelist.recursive_include("tsx/src", "*.c")
        self.filelist.recursive_include("tsx/src/tree_sitter", "*.h")
